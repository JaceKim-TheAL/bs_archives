...
<table>
  <tr valign="bottom">
    ...
    <td colspan="2" valign="center">
      <br/> ❶ 눌림목 : 추세복귀, 추세재시작 (이평선까지 눌렸을때)
      <br/> ❷ 리테스트 : 추세복귀, 진짜 돌파 시작 (저항 ⇒ 지지 전환)
      <br/> ❸ V반등 : 패닉반전, 강한 V자 반등 (패닉저점 + 거래량폭증)
      <br/> ❹ W바닥 : 이중바닥, 강한지지 확인  (짝궁뎅이 넥라인돌파)
      <br/> ❺ 추세선 : 추세유지, 추세 지속 신호 (추세선 터치후 반등)
      <br/> ❻ 박스하단 : 박스매매, 상단까지 반등 (박스하단 지지확인)
      <br/> ❼ 갭채움 : 갭지지, 추세 재진입 (갭자리에서 지지)
      <br/> ❽ 신고가 : 추세시작, 새 추세 진입 (저항돌파 + 거래량폭증)
    </td>
...
<table>
  <tr valign="bottom">
    ...
    <td>
      ...
      <br/> ❷ <b>거래량</b> : 평소 300% 이상으로 급증
      <br/> ❸ <b>지지선</b> : 박스권 하단 지지선을 터치
      <br/> ❹ <b>정배열</b> : 단기이평선이 정배열 <br/> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            (5일 > 20일 > 60일)
      <br/> ❺ <b>추세돌파</b> : 하락추세선을 강하게 돌파
      <br/>
      <br/>
...
> **7가지 중 단 하나라도 보이면 절반이라도 익절  ⇒ 수익 낸자만이 살아남는다!!**
...
<table>
  <tr align="center">
    <td><img src="./img/컵앤핸들_01.png" width="250"></td>
    <td><img src="./img/컵앤핸들_02.png" width="250"></td>
    <td><img src="./img/컵앤핸들_03.png" width="250"></td>
    <td><img src="./img/컵앤핸들_04.png" width="250"></td>
  </tr>
  <tr align="center">
    <td><img src="./img/컵앤핸들_05.png" width="250"></td>
    <td><img src="./img/컵앤핸들_06.png" width="250"></td>
    <td><img src="./img/컵앤핸들_07.png" width="250"></td>
    <td><img src="./img/컵앤핸들_08.png" width="250"></td>
  </tr>
  <tr align="center">
